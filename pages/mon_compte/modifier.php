    ...
    <form action="">
        <form action="" method="post">
            <div class="col">
                ...
                <input type="text" id="name_account" name="name_account" value="<?php echo $_SESSION['firstname'] ?>"
                    required>

                <label for="first_name_account">Prénom:</label>
                <input type="text" id="first_name_account" name="first_name_account"
            ...
            <div class="col">
                ...
                <input type="text" id="nbLicence" name="nbLicence" value="<?php echo $_SESSION['username'] ?>" disabled
                    style="color: white;">

                <label for=" id_account">Identifiant:</label>
                <input type="text" id="id_account" name="id_account" value="<?php echo $_SESSION['username'] ?>"
                    required>
